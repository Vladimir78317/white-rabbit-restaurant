/*
================================================================================
 WHITE RABBIT — ЕДИНЫЙ СКРИПТ УСТАНОВКИ БАЗЫ ДАННЫХ v2.8
================================================================================
 ...
 - все обновления v2.0, v2.1, v2.3, v2.4, v2.5, v2.6, v2.7 и v2.8;
 - исправления бронирования, смен и автоматического распределения столиков.
...
PRINT N'Единый скрипт White Rabbit v2.8 успешно выполнен.';
GO
