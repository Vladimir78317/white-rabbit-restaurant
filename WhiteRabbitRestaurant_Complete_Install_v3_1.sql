/*
================================================================================
 WHITE RABBIT — ЕДИНЫЙ СКРИПТ УСТАНОВКИ БАЗЫ ДАННЫХ v3.1
================================================================================
 ...
 - все обновления v2.0–v3.0 и исправление совместимости схемы v3.1;
...
(
    ...
    /*
       WAITER: заказ создан официантом и связан с открытой сменой.
       CLIENT_APP: заказ создан клиентом; смену официант возьмёт при выдаче.
       Заказ не может одновременно относиться к броне и посещению.
    */
...
PRINT N'Единый скрипт White Rabbit v3.1 успешно выполнен без ошибок совместимости схемы заказов.';
GO
