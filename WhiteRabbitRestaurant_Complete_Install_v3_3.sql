/*
================================================================================
 WHITE RABBIT v3.2 — ПОЛНАЯ УСТАНОВКА
 Создаёт базу с исправленной схемой заказов.
 ВНИМАНИЕ: исходный v3.0 скрипт удаляет существующую базу WhiteRabbitRestaurant.
================================================================================
*/
...
/* ===== Финальная проверка и переопределение процедур v3.2 ===== */
/*
================================================================================
...
END;
GO
PRINT N'White Rabbit v3.3: чистая установка завершена.';
GO
