...
IF @Missing IS NOT NULL
    THROW 51902, CONCAT(N'Восстановление завершилось не полностью. Отсутствуют: ', @Missing), 1;
...
SELECT
    ...
    N'White Rabbit v3.3: все объекты для приложения восстановлены.' AS [Результат];
GO
